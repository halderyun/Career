    ...
    with sqlite3.connect(DB_PATH, timeout=20.0) as conn:
        ...
        if cur.fetchone()[0] == 0:
            companies = [
                ...
                ('梅特勒-托利多（常州）测量技术有限公司', 10, '地址：新北区太湖西路111号。梅特勒托利多是目前精密仪器和称重解决方案的领导者。', '工程制造'),
                ...
                ('小松（常州）工程机械有限公司',10, '地址：新北区黄河西路389号。世界知名工程机械制造商，常州公司是小松在华的大中型重型设备与核心零部件制造基地，产品广泛用于矿山开采、交通建设等；拥有年产2.2万吨高效环保铸铁生产线，主要生产工程机械用高强度缸体及油压件。', '工程制造'),
                ('中信银行常州分行', 12, '地址：天宁区吊桥路1-41号。中信银行是中国改革开放中最早成立的新兴商业银行之一， 是中国最早参与国内外金融市场融资的商业银行，也是一家主营金融业务的股份有限公司。', '金融财会'),
                ('天纳克（常州）减振系统有限公司', 10, '地址：新北区浏阳河路36号。天纳克常州是美国天纳克集团全资子公司，年产机动车电控减振器超200万只，客户涵盖如理想、大众、沃尔沃、宝马、吉利汽车等多家国内外知名主机厂。', '工程制造'),
                ('威乐（常州）水泵有限公司', 5, '地址：新北区河海西路350号。威乐集团主要生产水泵，产品被广泛用于建筑领域、市政建设、水务、工业等领域。常州高新区项目集聚研发、生产、配送等多个功能，使用最先进生产设施，沿用威乐德国总部的超现代化智能工厂的运营方式与数字化标准流程。', '工程制造'),
...
START_TIME = datetime(2026, 6, 2, 7, 45, 0)
