    ...
    with sqlite3.connect(DB_PATH) as conn:
        ...
        if cur.fetchone()[0] == 0:
            companies = [
                ...
                ('常州三新供电服务有限公司', 10, '天宁区青洋北路157号。国网江苏省电力有限公司所属企业，主要从事乡镇供电所的生产经营业务，具体为农村配网线路和设备的巡视、检修和故障处理，电力业扩报装、装表接电、用电检查、电费回收和客户服务等工作。', '科创技术'),
                ('小松（常州）工程机械有限公司',10, '新北区黄河西路389号。世界知名工程机械制造商，常州公司年产能为1万台，产品广泛用于矿山开采、交通建设等；拥有年产2.2万吨高效环保铸铁生产线，主要生产工程机械用高强度缸体及油压件。', '工程制造'),
                ('中信银行常州支行', 10, '天宁区吊桥路1-41号。中信银行是中国改革开放中最早成立的新兴商业银行之一， 是中国最早参与国内外金融市场融资的商业银行，也是一家主营金融业务的股份有限公司。', '金融财会'),
