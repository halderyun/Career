...
def init_db():
    with sqlite3.connect(DB_PATH) as conn:
        ...
        if cur.fetchone()[0] == 0:
            companies = [
                ('常高新金隆控股（集团）有限公司', 4, '新北区秀水河路智富中心。常高新是常州高新区金融投资平台，服务实体经济发展，主要从事以自有资金从事投资活动、融资咨询服务等业务。', '金融财会'),
                ('常州常高新新能源产业投资有限公司', 4, '新北区秀水河路智富中心。常高新新能源主要聚焦新能源领域投资，推动绿色能源转型。', '科创技术'),
                ('贺尔碧格传动技术（常州）有限公司', 10, '新北区创业东路16号粤海工业园7A。贺尔碧格传动技术作为贺尔碧格集团的一大事业部，是汽车行业公认的换档装置和离合器方面的专家，主要生产汽车自动变速箱及其零部件。', '工程制造'),
                ('梅特勒-托利多（常州）测量技术有限公司', 10, '新北区太湖西湖111号。梅特勒托利多是目前精密仪器和称重解决方案的领导者。', '工程制造'),
                ('常州千红生化制药股份有限公司', 15, '新北区云河路518号。生物医药企业，专注于酶制剂和生化药品，主要生产冻干粉针剂（含抗肿瘤药）、小容量注射剂、片剂、胶囊剂、原料药。', '科创技术'),
                ('常州三新供电服务有限公司', 6, '天宁区青洋北路157号。国网江苏省电力有限公司所属企业，主要从事乡镇供电所的生产经营业务，具体为农村配网线路和设备的巡视、检修和故障处理，电力业扩报装、装表接电、用电检查、电费回收和客户服务等工作。', '科创技术'),
                ('小松（常州）工程机械有限公司',10, '新北区黄河西路389号。世界知名工程机械制造商，常州公司年产能为1万台，产品广泛用于矿山开采、交通建设等；拥有年产2.2万吨高效环保铸铁生产线，主要生产工程机械用高强度缸体及油压件。', '工程制造'),
                ('中信银行常州支行', 12, '天宁区吊桥路1-41号。中信银行是中国改革开放中最早成立的新兴商业银行之一， 是中国最早参与国内外金融市场融资的商业银行，也是一家主营金融业务的股份有限公司。', '金融财会'),
                ('天纳克（常州）减振系统有限公司', 10, '新北区浏阳河路36号。天纳克常州是美国天纳克集团全资子公司，年产机动车减振器、独立悬挂、减振器芯总成和专用减振器1800万只，客户涵盖如理想、大众、通用、长安福特、奔驰、宝马、吉利汽车等40多家国内外知名主机厂。', '工程制造'),
                ('威乐（常州）水泵有限公司', 5, '新北区河海西路350号。威乐集团主要生产水泵，产品被广泛用于建筑领域、市政建设、水务、工业等领域。常州高新区项目集聚研发、生产、配送等多个功能，使用最先进生产设施，运用威乐德国总部新落成的超现代化智能工厂的运营方式与数字化标准流程。', '工程制造'),
                ('智阅空间儿童读书会', 6, '常州新华书店（和平北路店）。“阅读＋教育＋心理”的跨界成长空间，定期举办主题读书会与创意互动，展示如何运用教育心理学激发儿童的阅读力与思辨力，是探索教育与文化传播行业的绝佳窗口。', '人文教育')
            ]
...
START_TIME = datetime(2026, 6, 2, 13, 20, 0)
